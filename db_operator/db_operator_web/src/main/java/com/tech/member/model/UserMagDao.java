...
@Repository
public interface UserMagDao extends QueryConsoleMapper{
	/**
	 * 获取功能菜单列表
	 * @author zhongqiang.xiang
	 * @version 创建时间：2017年4月5日  下午5:12:44
	 * @return
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	public int ifHasUserName(String userName) throws Exception;
	/**
	 * 插入用户信息
	 * @author zhongqiang.xiang
	 ...
	 * @throws Exception
	 */
	public void insertUserInfo(RegistInfo registInfo) throws Exception;
	/**
	 * 获取数据源信息
	 * @author zhongqiang.xiang
	 ...
	 * @throws Exception
	 */
	public void updateUserDelflagById(String userId) throws Exception;
}
