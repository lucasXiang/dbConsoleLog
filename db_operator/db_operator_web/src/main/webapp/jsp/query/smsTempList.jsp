...
// 							trs += '</tr>';
							trs += '<td>';
							if(res.smsRole!=null && res.smsRole != '' && res.smsRole.indexOf('1')!=-1){
								trs += '<a href="#" onclick="modifySmsTemp(this)">修改</a>';
							}
							trs += '&nbsp;';
							if(res.smsRole!=null && res.smsRole != '' && res.smsRole.indexOf('2')!=-1){
								trs += '<a href="#" onclick="delSmsTemp(this);">删除</a>';
							}
							trs += '</td></tr>';
						}
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="con_search_right20"><span
						...
						<c:if test="${fn:contains(smsRole,'0')}"><input name="button232"
							type="button" class="buttonStyle-2word" value="新增"
							onclick="addOneSmsTemp();" /> </c:if>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0"
				...
				<c:forEach items="${objs}" var="obj" varStatus="s">
					<tr class="tableConBg">
						...
						<td>
							<c:if test="${fn:contains(smsRole,'1')}">
								<a href="#" onclick="modifySmsTemp(this)">修改</a>
							</c:if>
							&nbsp;
							<c:if test="${fn:contains(smsRole,'2')}">
								<a href="#" onclick="delSmsTemp(this);">删除</a>
							</c:if>
						</td>
					</tr>
				</c:forEach>
